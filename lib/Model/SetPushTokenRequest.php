...
/**
 * SetPushTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetPushTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetPushTokenRequest';
    ...
    protected static $openAPITypes = [
        'push_token' => 'string',
        'description' => 'string',
        'device' => '\OpenAPI\Client\Model\DeviceType',
        'public_key' => 'string'
    ];
     ...
     * Sets device
     *
     * @param \OpenAPI\Client\Model\DeviceType|null $device device
     *
     * @return self
     */
