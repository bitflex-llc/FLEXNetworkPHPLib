...
/**
 * VerifyResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerifyResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyResult';
    ...
    {
        $this->container['is_identical'] = $data['is_identical'] ?? null;
     ...
     * Sets is_identical
     *
     * @param bool|null $is_identical is_identical
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param double|null $confidence confidence
     *
     * @return self
     */
