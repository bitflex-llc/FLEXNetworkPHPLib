...
/**
 * FinishTier1VerificationModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FinishTier1VerificationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishTier1VerificationModel';
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling FinishTier1VerificationModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFullName($full_name)
    {
        ...
        if ((mb_strlen($full_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $full_name when calling FinishTier1VerificationModel., must be bigger than or equal to 1.');
        }
